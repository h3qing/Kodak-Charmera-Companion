      ...
      <div class="max-w-2xl mx-auto p-6">
        ...
        <div class="mb-6">
          <button
            onClick={pickImage}
            disabled={loading()}
            class="inline-flex items-center gap-2 px-5 py-2.5 bg-kodak-yellow hover:bg-kodak-yellow-dark text-kodak-charcoal font-semibold rounded-lg transition-colors disabled:opacity-50"
          >
